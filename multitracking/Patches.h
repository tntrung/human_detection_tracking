...
public:
	...
	PatchesRegularScan(Rect imageROI, Rect validROI, Size patchSize,Rect newrect[],int sovungrect, float relOverlap);
...
private:
	...
	void calculatePatches(Rect imageROI, Rect validROI, Size patchSize,Rect newrect[],int sovungrect, float relOverlap);
