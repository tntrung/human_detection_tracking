...
bool StrongClassifierStandard::update(CvHistogram*hist,ImageRepresentation *image, Rect ROI, int target, float importance)
{
	int curBaseClassifier;
	for (curBaseClassifier = 0; curBaseClassifier<numBaseClassifier; curBaseClassifier++)
	{
...
bool StrongClassifierStandard::update(CvHistogram*image, Rect ROI, int target, float importance)
{
	int curBaseClassifier;
	for (curBaseClassifier = 0; curBaseClassifier<numBaseClassifier; curBaseClassifier++)
	{
